...
- `oiloil-ui-ux-guide`: UI/UX review and guidance skill. Use `$oiloil-ui-ux-guide` for design reviews, P0/P1/P2 prioritized fixes, and modern minimal UI principles. Located at `.opencode/skills/oiloil-ui-ux-guide/`
