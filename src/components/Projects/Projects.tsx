...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Personal portfolio showcasing full-stack expertise. Features CSS animation showcase, interactive piano, and visual effects.",
    tags: ["React", "TypeScript", "CSS", "Vite"],
    date: "2026-02",
    link: "#",
    status: "active",
    image: "/assets/projects/developer-portfolio.webp",
  },
  {
    id: "proj-5",
    hash: "sc2k-vw",
